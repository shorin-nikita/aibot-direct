...
echo ""
echo "2️⃣ Связь с GitHub:"
echo "   git remote add origin https://github.com/shorin-nikita/aibot-direct.git"
echo ""
echo "3️⃣ Публикация:"
...
echo ""
echo "   git clone https://github.com/shorin-nikita/aibot-direct.git"
